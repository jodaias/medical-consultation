...
SELECT
    ...
    COUNT(*) as count
FROM "users" u
LEFT JOIN "doctor_profiles" dp ON u."id" = dp."userId"
...
AND tablename IN ('users', 'doctor_profiles', 'patient_profiles', 'consultations', 'messages', 'schedules', 'prescriptions', 'ratings', 'reports')
